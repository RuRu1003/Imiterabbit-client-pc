                            ...
                            <td>
                                <div class="goods">
                                    ...
                                    <div>
                                        ...
                                        <!-- 选择规格组件 -->
                                        <CartSku @change="updateCartSku(goods.skuId, $event)" :skuId="goods.skuId" :attrsText="goods.attrsText" />
                                    </div>
                                </div>
                            </td>
                            <td class="tc">
...
export default {
  ...
  setup () {
    ...
    return { checkOne, checkAll, deleteCart, updateCount, updateCartSku, batchDeleteCart, checkout }
  }
}
</script>
